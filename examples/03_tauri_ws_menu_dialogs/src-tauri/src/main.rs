...
fn main() {
  ...
  let menu = Menu::new()
    ...
    .add_submenu(Submenu::new(
      "Dialog",
      Menu::new()
        .add_item(CustomMenuItem::new("dialog::ask".to_string(), "Ask"))
        .add_item(CustomMenuItem::new("dialog::confirm".to_string(), "Confirm"))
        .add_item(CustomMenuItem::new("dialog::message".to_string(), "Message"))
        .add_item(CustomMenuItem::new("dialog::open".to_string(), "Open"))
        .add_item(CustomMenuItem::new("dialog::save".to_string(), "Save"))
    ));
